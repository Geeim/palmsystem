...
// MODAL SET UP
    ...
    SetUpForm.addEventListener('submit', function(event) {
        ...
        if (this.checkValidity()) {
            ...
            $.ajax({
                type: 'POST',
                url: 'Function/DRCheckSetUpModalUpland.php',
                data: { 
...
//SUBMIT THE INPUT HARVESTING
    ...
    SubmitDataHarvestedID.addEventListener('click', function() {
        ...
        if (CheckRows) {
            $.ajax({
                url: 'Function/DRHarvestingFunctionUpland.php',
                type: 'POST',
...
//SUBMIT THE INPUT PLANTING
   ...
   SubmitDataPlantedID.addEventListener('click', function() {
       ...
       if (CheckRows) {
           $.ajax({
               url: 'Function/DRPlantingFunctionUpland.php',
               type: 'POST',
...
//DELETE LINE TABLE
    function DeleteHarvesting(year, month, range_date) {
        if (confirm('Are you sure you want to delete this harvesting record?')) {
            $.ajax({
                url: 'Function/DATAUplandDeleteHarvesting.php',
                type: 'POST',
                data: {
                    year: year,
                    month: month,
    ...
    function DeletePlanting(year, month, range_date) {
        if (confirm('Are you sure you want to delete this planting record?')) {
            $.ajax({
                url: 'Function/DATAUplandDeletePlanting.php',
                type: 'POST',
                data: {
                    year: year,
                    month: month,
...
//PLANTING PART UPLAND

    //FETCH UPLAND PLANTING VIEW AND UPDATE
    let updatedDataNPR = [];
    let updatedDataRCEF = [];
    ...
    function ViewPlanting(year, month, range_date) {
        $.ajax({
            url: 'Function/DATAUplandViewPlanting.php',  // PHP script to fetch data
            type: 'POST',
            data: {
                year: year,
                month: month,
            ...
            success: function(response) {
                ...
                $('#saveChanges').on('click', function() {
                    ...
                    $.ajax({
                        url: 'Function/UpdateDATAUplandPlanting.php',  // PHP script to save updated data
                        type: 'POST',
...
//HARVESTING PART UPLAND

    //FETCH UPLAND HARVESTING VIEW AND UPDATE
    ...
    function ViewHarvesting(year, month, range_date) {
        $.ajax({
            url: 'Function/DATAUplandViewHarvesting.php',  // PHP script to fetch data
            type: 'POST',
            data: {
                year: year,
                month: month,
            ...
            //GET THE AVERAGE YIELD
                ...
                //GET UPDATE
                    ...
                    $('#saveChangesHarvesting').on('click', function() {
                        ...
                        $.ajax({
                            url: 'Function/UpdateDATAUplandHarvesting.php',  // PHP script to save updated data
                            type: 'POST',
                            data: dataToSend,  // Stringify the updatedData before sending
                            dataType: 'json',  // Expecting a JSON response
                            success: function(response) {
...
$(document).on('submit', '#exportupland', function (e) {
    e.preventDefault();

    var ExportUplandForm = new FormData(this);

    $.ajax({
        type: "POST",
        url: "Function/checkexist_upland.php",  // URL of the PHP script that processes the form data
        data: ExportUplandForm,
        processData: false,
        contentType: false,
        success: function (response) {
            var res = JSON.parse(response);
            ...
            if (res.status == 'SUCCESS') {
               $('#btnexportUpland').prop('disabled', true).text('Downloading...');
               $('#monthexportUpland').prop('disabled', true);
               ...
               setTimeout(function() {
                    ...
                    $('#yearExportUpland').prop('disabled', false);
                    $('#mayorsnameexportUpland').prop('disabled', false);
