...
<head>
    ...
    <link rel="stylesheet" href="systemcss/MADRirrigated.css">
...
<!--MODAL VIEW PLANTING NO UPDATE-->
            ...
            <div class="modal-content bg-light">
                ...
                <form id="exportirrigated">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group mt-3">
                            <label class="yearExportIrrigated text-secondary" for="mayorsnameexportIrrigated">Mayor's Name : </label>
    ...
    <script src="systemjs/MADRirrigated.js"></script>
