...
include '../connection.php';
    ...
    if ($selectedType == "Planting") {
        ...
        $SQL = "SELECT * FROM `planting` WHERE `landtype` = '3' AND `month` = '$monthpick' AND `year` = '$yearInsert' AND `range_date` = '$rangeDate'";
        ...
        $SQL = "SELECT * FROM `harvesting` WHERE `landtype` = '3' AND `month` = '$monthpick' AND `year` = '$yearInsert' AND `range_date` = '$rangeDate'";
        $Result = mysqli_query($con, $SQL);
