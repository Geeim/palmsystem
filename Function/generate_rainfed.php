...
$Mayor = $_GET['Mayor'];
    ...
    $stmtcheckPlanting = $con->prepare("SELECT * FROM `planting` WHERE  `landtype` = 2 AND `month` = ? AND `range_date` = ? AND `year` = ?");
    ...
    $stmtcheckHarvesting = $con->prepare("SELECT * FROM `harvesting` WHERE `landtype` = 2 AND `month` = ? AND `range_date` = ? AND `year` = ?");
...
// WORKSHEET FOR HARVESTING (sheet1)
    ...
    //MERGE CELL
        ...
        $sheet1->mergeCells('E7:AQ7'); //RAINFED
    ...
    //VALUE DESIGN
        ...
        $sheet1->setCellValue('E7', 'RAINFED');
    ...
    //COLOR
        ...
        $sheet1->getStyle('E7')->getFill()->getStartColor()->setRGB('ADB9CA');  // RAINFED COLOR
    ...
    //SUM COMPUTATION - LINE 35
        ...
        // OK
        $sheet2->mergeCells('D7:AC7'); //RAINFED
    ...
    // VALUE
        ...
        $sheet2->setCellValue('D7', 'RAINFED');
    ...
    //COLOR
        ...
        $sheet2->getStyle('D7')->getFill()->getStartColor()->setRGB('ADB9CA');  // RAINFED COLOR
    ...
    $filename ='RAINFED ' . $monthName . ' ' . $range_date . ' ' . $year . ' REPORT';
