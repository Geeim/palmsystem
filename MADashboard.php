...
<head>
    ...
    <link rel="stylesheet" href="systemcss/MADashboard.css">
...
<body>
            ...
            <div class="sidebar-logo text-white">
             ...
             <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a data-url="MAmyaccount.php?validation=true" class="sidebar-link navlink">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="DR" class="sidebar-dropdown list-unstyled">
                        <li class="sidebar-item">
                            <a data-url="MADRirrigated.php?validation=true" class="sidebar-link navlink">
                                <div class="submenu-text">Irrigated Ecosystem</div>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a data-url="MADRrainfed.php?validation=true" class="sidebar-link navlink">
                                <div class="submenu-text">Rainfed Ecosystem</div>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a data-url="MADRupland.php?validation=true" class="sidebar-link navlink">
                ...
                <li class="sidebar-item">
                    <a data-url="Function/MAlogout.php" id="logout" class="sidebar-link">
    ...
    <script src="systemjs/MADashboard.js" defer></script>
</body>
</html>